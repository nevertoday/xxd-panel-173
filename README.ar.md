...
# XXD Panel 173｜مشهد مصغر من الورق والنص بلون العاج
...
تتضمن هذه الدفعة نموذجاً مولداً واحداً اجتاز فحص النسبة الأساسي وفحص الصورة المصغرة (`assets/examples/sample-03.png`)؛ أما المرشحون المعاد توليدهم الآخرون فما زالوا خارج النماذج المنشورة بانتظار المراجعة. تم فحص سلامة النص والروابط وأدوات التشغيل.
...
مشهد ورقي نصي بنسبة 10–20% وفراغ دافئ 80–90%؛ نحو 95% من الألوان عاجي وبيج رمادي وبني ورقي، دون أحمر أو ذهبي أو أزرق ظاهر.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 173 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-173`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-173 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-173-prompt.en.md) أو [بالصينية](references/xxd-panel-173-prompt.zh-CN.md).
